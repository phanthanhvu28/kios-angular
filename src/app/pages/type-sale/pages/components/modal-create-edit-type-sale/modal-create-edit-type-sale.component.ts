...
import TypeSaleBaseDto, { DropdownValueStore } from '@pages/type-sale/models/type-sale.model';
...
@Component({
  selector: 'app-modal-create-edit-type-sale',
  templateUrl: './modal-create-edit-type-sale.component.html',
  styleUrls: ['./modal-create-edit-type-sale.component.less']
})
export class ModalCreateEditTypeSaleComponent extends AbsBaseModalComponent {
  sizeModal: number | string = 820;
  isFullScreen: boolean = false;
  @Input() id: string = null;
  @Input() dataDetail: TypeSaleBaseDto;

  @Input() filter: DataFilterTypeSale;
  ...
  constructor(
    ...
    super();
    this.loading$ = this.typeSaleService.loading$;
    this.watch();
    //this.loadCommon();
  ...
  private watch(): void {
    ...
    this.typeSaleService.entityObservable$
  ...
  onSave(): void {
    ...
    if(this.dataDetail?.code){    
      ...
      this.typeSaleService.update(payloadNew);
    }
    else{
      this.typeSaleService.create(payload);
    }
  }
  initDataForm(): void {
